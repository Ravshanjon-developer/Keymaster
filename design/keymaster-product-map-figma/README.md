...
## Create the Figma file (Starter plan = max 3 pages)

The plugin maps 7 logical boards onto **3 physical pages** (`01–03 Screens`, `04–05 System`, `06–07 Mobile`) so it works on Figma Starter.

1. Open [Figma Desktop](https://www.figma.com/downloads/).
2. Open the draft file (or create one): **KeyMaster — Product Map (Current UI)**  
   Already created: https://www.figma.com/design/jKGV7elxvRpqM7B4Bd9QUt
3. **Plugins → Development → Import plugin from manifest…**
4. Select `manifest.json` in this folder (`design/keymaster-product-map-figma/`).
