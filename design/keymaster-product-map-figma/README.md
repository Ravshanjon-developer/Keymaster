...
| Page | Contents |
|---|---|
| `01 — Product Map` | 4 layouts, IA sitemap, unique pages grouped by layout, editable as-is recreations (auth compact register, catalog filters, exam setup/run/feedback/done, dark login/courses, mobile chips) |
