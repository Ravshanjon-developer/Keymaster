...
const ru: Record<number, TaskCopy> = {
  ...
  6: {
    ...
    description: 'Скопируйте любой файл и вставьте копию в другое место.',
...
const tg: Record<number, TaskCopy> = {
  ...
  6: {
    ...
    description: 'Як файли дилхоҳро нусха кунед ва дар ҷои дигар гузоред.',
    hint: 'Клики рост → «Нусха», сипас клики рост → «Гузоштан».',
  },
  7: {
