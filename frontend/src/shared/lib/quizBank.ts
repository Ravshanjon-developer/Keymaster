...
export const HOTKEYS_QUIZ_BANK: QuizBankItem[] = [
  ...
  },
  {
    ...
    question: {
      ...
      tg: 'Кадом комбинатсия мизи кориро зуд нишон медиҳад ва равзанаҳои кушодаро пинҳон мекунад?',
    },
    options: [o('Win + E'), o('Win + D'), o('Win + Tab'), o('Alt + D')],
    correctIndex: 1,
    explanation: {
      ru: 'Win+D — показать рабочий стол.',
      tg: 'Win+D — мизи корро нишон медиҳад.',
    },
  },
  {
    id: 17,
  ...
  },
  {
    ...
    question: {
      ...
      tg: 'Шумо мехоҳед файлро аз як папка ба папкаи дигар интиқол диҳед. Кадом пайдарпайии амалҳо дуруст аст?',
    },
    options: [
