...
export const contentTg: ContentCatalogTg = {
  ...
  categories: {
    'computer-basics/basics': 'Файлҳо ва папкаҳо',
    'computer-basics/explorer': 'Машқ дар проводник',
    'computer-basics/trash-zip': 'Сабад ва ZIP',
    'computer-basics/project': 'Сохтори лоиҳа',
  ...
  lessons: {
    'computer-basics/explorer/desktop:1': {
      title: 'Папкаи Practice',
      action_prompt: 'Дар мизи кор папкаи Practice эҷод кунед',
      usage_example: 'Клики рост → Папкаи нав → Practice',
      description: 'Номҳои лотинӣ барои барномаҳо осонтаранд.',
    },
    'computer-basics/explorer/desktop:2': {
      title: 'Файли notes.txt',
      action_prompt: 'Дар мизи кор notes.txt эҷод кунед',
    ...
    'computer-basics/explorer/desktop:4': {
      title: 'Папкаи Projects',
      action_prompt: 'Папкаи Projects эҷод кунед',
      usage_example: 'Клики рост → Папкаи нав → Projects',
      description: 'Лоиҳаҳоро алоҳида нигоҳ доред.',
    },
    ...
    'computer-basics/trash-zip/desktop:7': {
      title: 'Нест кардан ба сабад',
      action_prompt: 'Файлро нест кунед — ба сабад меравад',
    ...
    'computer-basics/trash-zip/desktop:8': {
      title: 'Барқарор аз сабад',
      action_prompt: 'Файли нестшударо барқарор кунед',
      usage_example: 'Сабад → клики рост → Барқарор',
      description: 'Shift+Delete бе сабад нест мекунад.',
    },
    ...
    'programmer-basics/system/Meta+D': {
      title: 'Мизи кор',
      action_prompt: 'Мизи кор',
      usage_example: 'Win+D',
      description: 'Мизи кор',
    },
